...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Component render hone par Content fetch karo
      ...
      <div className="flex-1 ml-64 p-8">
        ...
        <header className="flex justify-between items-center mb-10 pt-2">
          ...
          <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white px-5 py-2.5 rounded-lg font-medium transition-colors shadow-lg shadow-indigo-500/20">
